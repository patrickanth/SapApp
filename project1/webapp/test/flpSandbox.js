		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nameSpaceProvaproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nameSpaceProvaproject1-display": {
								"semanticObject": "nameSpaceProvaproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nameSpaceProva.project1",
									"url": sap.ui.require.toUrl("nameSpaceProva/project1")
								}
							}
						}
					}
